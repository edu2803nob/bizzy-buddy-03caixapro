...
import { Plus, Minus, Trash2, ShoppingCart, Search, Check } from "lucide-react";
...
export default function PDV() {
  ...
  const finalizeSale = () => {
    ...
    registrarVenda(total, totalItens, produtosVendidos);
                ...
                <TableBody>
                  ...
                  {disponíveis.map(p => {
                    ...
                    return (
                      <TableRow
                        key={p.id}
                        className="cursor-pointer hover:bg-primary/5 transition-colors active:bg-primary/10"
                        onClick={() => addToCart(p)}
                      >
                        <TableCell>
                        ...
                        <TableCell className="text-right tabular-nums text-xs">
                          <span className={p.estoque <= 5 ? "text-destructive font-medium" : "text-muted-foreground"}>
                            {p.estoque} un.
                          </span>
                        </TableCell>
